      ...
      <div className="projects">
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              <h3>GITHUB CLONE</h3>
              <div><img src="./Images/olx.jpeg" alt="Github Clone" width="350" height="250"/> </div>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              <h3>OLX-CLONE</h3>
              <div><img src="./Images/Netflix2.png" alt="OLX Clone" width="350" height="250" /> </div>
              <p>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              <h3>NETFLIX-CLONE</h3>
              <div><img src="./Images/Netflix.png" alt="Netflix Ent Clone" width="350" height="250"/> </div>
              <p>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              ...
              <div><img src="./Images/health.jpeg" alt="Health" width="350" height="250"/> </div>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              ...
              <div><img src="./Images/CAR.jpeg" alt="CAR" width="350" height="250"/> </div>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              ...
              <div><img src="./Images/credit.jpeg" alt="CREDIT" width="350" height="250"/> </div>
              <p>
